    ...
    <main className="relative flex min-w-0 h-full w-full min-h-0 items-center justify-center overflow-hidden bg-[#f6f7f9] p-0 md:p-6">
      ...
      <div className={`relative z-10 h-full w-full ${previewSizeClass[previewMode]}`}>
        <div 
          ...
          className="h-full overflow-y-auto overflow-x-hidden rounded-none md:rounded-[28px] bg-white shadow-none md:shadow-[0_35px_90px_-60px_rgba(15,23,42,0.6)]"
          style={{ transform: 'translate3d(0,0,0)' }}
        >
          <TemplateComponent
            funnel={{ ...funnel, story_mode_data: [{ ...(funnel.story_mode_data?.[0] ?? {}), content: content as any }] }}
            store={{
