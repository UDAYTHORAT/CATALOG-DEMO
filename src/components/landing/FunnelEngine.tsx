...
export default function FunnelEngine() {
  ...
  return (
    <section id="flow-engine" className="relative w-full min-h-[1100px] pt-24 pb-32 border-t border-slate-100 overflow-hidden bg-slate-50 select-none">
      ...
      <div className="flex items-center justify-center relative overflow-visible w-full px-4 md:px-6">
        <motion.div 
        ...
        >
          ...
          >
            ...
            <motion.path initial={{ pathLength: 0 }} animate={{ pathLength: isActivated ? 1 : 0 }} transition={{ duration: 0.8, delay: 0.8 }} d="M 500 120 L 500.01 285" stroke="#cbd5e1" strokeWidth="2" fill="none" />
            <motion.path initial={{ pathLength: 0 }} animate={{ pathLength: isActivated ? 1 : 0 }} transition={{ duration: 0.8, delay: 0.95 }} d="M 250 170 C 250 250, 480 250, 480 285" stroke="#cbd5e1" strokeWidth="2" fill="none" />
            <motion.path initial={{ pathLength: 0 }} animate={{ pathLength: isActivated ? 1 : 0 }} transition={{ duration: 0.8, delay: 1.1 }} d="M 750 170 C 750 250, 520 250, 520 285" stroke="#cbd5e1" strokeWidth="2" fill="none" />
            <motion.path initial={{ pathLength: 0 }} animate={{ pathLength: isActivated ? 1 : 0 }} transition={{ duration: 0.8, delay: 1.25 }} d="M 150 250 C 350 250, 440 295, 465 295" stroke="#cbd5e1" strokeWidth="2" fill="none" />
            <motion.path initial={{ pathLength: 0 }} animate={{ pathLength: isActivated ? 1 : 0 }} transition={{ duration: 0.8, delay: 1.4 }} d="M 850 250 C 650 250, 560 295, 535 295" stroke="#cbd5e1" strokeWidth="2" fill="none" />
          ...
          <motion.div 
            ...
            className="absolute top-[150px] left-[250px] -translate-x-1/2 -translate-y-1/2 z-10"
          >
          ...
          <motion.div 
            animate={{ opacity: isActivated ? 1 : 0, y: isActivated ? 0 : 20 }}
            transition={{ duration: 0.5, delay: 0.6 }}
            className="absolute top-[250px] left-[150px] -translate-x-1/2 -translate-y-1/2 z-10"
          >
          ...
          <motion.div 
            ...
            className="absolute top-[250px] left-[850px] -translate-x-1/2 -translate-y-1/2 z-10"
          >
          ...
          <motion.div 
            ...
            transition={{ type: 'spring', damping: 12, stiffness: 120, delay: 1.2 }}
