...
export const StickyTabItem: React.FC<StickyTabItemProps> = () => {
  return null;
};
...
const StickyTabs: React.FC<StickyTabsProps> & { Item: React.FC<StickyTabItemProps> } = ({
  ...
  rootClassName = "bg-[#070b14] text-white",
  navSpacerClassName = "border-b border-white/10 bg-[#070b14]",
  sectionClassName = "bg-[#0a0f1d] border-b border-white/5",
  stickyHeaderContainerClassName = "shadow-lg",
  headerContentWrapperClassName = "border-b border-white/10 bg-[#070b14]",
  headerContentLayoutClassName = "mx-auto max-w-7xl px-6 py-5 sm:px-10",
  titleClassName = "my-0 text-xl font-bold leading-none md:text-2xl lg:text-3xl text-white",
  contentLayoutClassName = "mx-auto max-w-7xl px-6 py-16 sm:px-10",
}) => {
